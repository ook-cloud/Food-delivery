...
export const FacebookIcon = (props) => (
  <svg
    ...
    {...props}
  >
    <path fill="url(#facebook-pattern)" d="M0 0h28v27.035H0z" />
    <defs>
      <pattern
        id="facebook-pattern"
        width={1}
